...
!      INCLUDE 'parameters_add_CO2.txt'
     ...
     9  LIS,LISO21,LISO23,LIHSO3,LISO3,LIN2
      INTEGER OTYPE 
      REAL COR1(NZ),COR2(NZ),COR3(NZ),COR4(NZ),TEMP181(NZ)
      REAL TEMP182(NZ),TEMP171(NZ),TEMP172(NZ),JJJ 
      

C    Y = 103.61*EXP(-0.324*P(NZ)); Y = DELTA-18,P(NZ) IN BAR
      DO I = 1,NZ 
      COR1(I) = 1.-0.0306525*EXP(-0.305*P(I))*(P(I)-0.0113)!17O; 8.5 torr from Tuzson 2005 figure 4.4
      COR2(I) = 1.-0.0335664*EXP(-0.324*P(I))*(P(I)-0.0113)!18O; Tuzson data for rxn 35,36 only
      COR3(I) = 1.-0.0306525*EXP(-0.305*P(I))*(P(I)-0.267) !17O;from Janssen 2001; at 0.267 bar
      COR4(I) = 1.-0.0335664*EXP(-0.324*P(I))*(P(I)-0.267) !18O;
      TEMP181(I)=(T(I)-296.)*1.03E-3
      TEMP182(I)=(T(I)-295.)*2.05E-5
      TEMP171(I)=(T(I)-296.)*1.03E-3*(2.4/3.25)
      TEMP172(I)=(T(I)-295.)*2.05E-5*(2.4/3.25)
      END DO 
c

C-------FIRST FLAG: ONE ISOTOPE----------------------------     
      IF(OTYPE .NE. 1) GO TO 21 
      DO 13 I = 1,NZ 
      AI(34,I) = AR(18,I)  *(1.03+0.92)/2.!*((T(I)-295.)*(1.03E-3)+1.)   !* 0.92 *1.2   ! same Q + O2 + M = O2Q + M
...
C
C-------TWO ISOTOPE ------------------
C COEFFICIENT FROM TABLE 6.4 OF TUZSON 2005 BY VISIBLE LIGHT PHOTOLYSIS UNDER LOW PRESSURE 
C    SECOND FLAG: 17O   

   21 IF(OTYPE.NE.2) GO TO 22
      JJJ = 1.0
      DO 14 I = 1,NZ 
      AI(34,I) =AR(18,I)*(1.03+TEMP171(I))*COR3(I) ! same Q + O2 + M = O2Q + M
      AI(35,I) =AR(18,I)/2.*(1.292+TEMP172(I))*COR1(I)*0.9772 ! half O + OQ + M = O2Q + M
      AI(36,I) =AR(18,I)/2.*(1.005+TEMP172(I))*JJJ !half O + OQ + M = OQO + M
      AI(320,I)= 3.4E-12*((300./T(I))**1.1)!Lessard et al 2003  
      AI(321,I)=AI(320,I)/((1.9727*EXP(16.93/T(I)))*
     2 (1-6.79E-6*T(I)+1.2E-8*T(I)*T(I)))
   14   END DO 
      GO TO 25 

C    THIRD FLAG: 18O  
   22 IF(OTYPE.EQ.3) THEN 
      DO 15 I = 1,NZ 
      JJJ = 1.0
      AI(34,I) =AR(18,I)  *(0.92+TEMP181(I))*COR4(I)*JJJ  ! same Q + O2 + M = O2Q + M
      AI(35,I) =AR(18,I)/2.*(1.426+TEMP182(I))*COR2(I)*JJJ ! half O + OQ + M = O2Q + M
      AI(36,I) =AR(18,I)/2.*(1.007+TEMP182(I))*JJJ ! half O + OQ + M = OQO + M
      AI(320,I)= 3.4E-12*((300./T(I))**1.1)!Lessard et al 2003 18O  ~1700times O3 formation rate at 100hPa
      AI(321,I)=AI(320,I)/((1.9481*EXP(31.652/T(I)))*
     2 (1-1.28E-5*T(I)+2.32E-8*T(I)*T(I)))
   15   END DO 
      GO TO 25
   ...
   25 CONTINUE
      ...
      AI(287,I)= 0.0         !AR(50,I)/2. ! half HOQ + HV = QH + O 
      AI(288,I)= AR(50,I)    ! JL SAME HOQ + HV = QH + O
...
C ***** FILL UP RATE MATRIX *****
      ...
      AI(9,I) = AR(6,I)/2. !JL HALF H + OQ + M = HOQ + M
      AI(10,I) = AR(7,I) ! same H + HOQ = H2 + OQ

c   jl tempo
      AI(11,I) = 0.0!AR(8,I)/2.! half H + HOQ = H2Q + O
      ...
      AI(18,I) = 0.0   !JL ZERO OUT AR(12,I) QH + O3 = HOQ + O2
      ...
      AI(31,I) = AR(16,I)/2.! JL HALF H2OQ + OH = HOQ + H2O  
...
c
      ...
      AI(70,I) = AR(44,I)/2.!JL HALF HCO + OQ = HOQ + CO
      ...
      AI(77,I) = AR(49,I)/2.! JL HALF H2OQ + O = OH + HOQ
      ...
      AI(92,I) = 0.!AR(70,I)/2. !JL HALF CH3 + OQO  =  H2CO + HOQ
      ...
      AI(102,I)= AR(74,I)/2. !JL HALF H3CO + OQ  =  H2CO + HOQ 
      ...
      AI(125,I)= AR(85,I) ! JL SAME NO + HOQ  =  NOQ + OH
      AI(126,I)= 0. !JL ZERO OUTAR(85,I)/2. NO + HOQ  =  NO2 + QH
      ...
      AI(170,I)= AR(102,I) !same QH + NO3  =  HOQ + NO2 
      AI(171,I)= AR(102,I)/3. !JL 1/3 OH + NO2Q  =  HOQ + NO2
      AI(172,I)= AR(102,I)*2./3. !JL 2/3 OH + NO2Q  =  HO2 + NOQ 
      ...
      AI(191,I)= AR(114,I) !JL SAME  SO   + HOQ  =     SOQ  +     OH
      AI(192,I)= AR(114,I) !JL SAME  SO   + HOQ  =     SO2  +     QH
      ...
      AI(204,I)= AR(120,I)/2. ! JL HALF HSO3 + OQ   =     HOQ  +     SO3 
      ...
      AI(221,I)= AR(138,I) !JL SAME S    + HOQ  =     SQ   +     OH  
      AI(222,I)= AR(138,I) !JL SAME S    + HOQ  =     SO   +     QH 
      ...
      AI(246,I)= AR(155,I)!/2. !JL SAME SO2   +    HOQ =      SO2Q  +    OH
      AI(247,I)= AR(155,I)!/2. !JL SAME SO2   +    HOQ =      SO3  +     QH
...
c      AI(320,I)= 3.4E-12*((300./T(I))**1.1)!Lessard et al 2003   ~1700 times O3 formation rate at 100hPa
c      AI(321,I)=AI(320,I)/(1.9727*EXP(16.93/T(I)))
...
C-JL ADD HQO AND HQONO2 
      AI(326,I)= AR(6,I)/2. ! H + OQ + M --> HQO + M 
      AI(327,I)= AR(7,I)    ! H + HQO --> H2 + OQ 
      AI(328,I)= AR(8,I)    ! H + HQO --> H2Q + O 
      AI(329,I)= AR(9,I)    ! H + HQO --> OH + OH 
      AI(330,I)= AR(11,I)   ! OH + HQO --> H2O + OQ 
      AI(331,I)= AR(12,I)   ! QH + O3 --> HQO + O2
      AI(332,I)= AR(13,I)   ! HQO + O --> OH + OQ 
      AI(333,I)= AR(14,I)   ! HQO + O3 --> OH + OQ + O2 
      AI(334,I)= AR(15,I)   ! HQO + HO2 --> H2O2 + OQ 
      AI(335,I)= AR(15,I)   ! HQO + HO2 --> H2OQ + O2 
      AI(336,I)= AR(16,I)/2.! H2OQ + OH --> HQO + H2O 
      AI(337,I)= AR(44,I)/2.! HCO + OQ --> HQO + CO 
      AI(338,I)= AR(49,I)/2.! H2CQ + O --> HQO + OH 
      AI(339,I)= AR(50,I)   ! HQO + HV --> QH + O 
      AI(340,I)= AR(70,I)!/2.! CH3 + OQO --> H2CO + HQO 
      AI(341,I)= AR(71,I)   ! CH3O2 + HQO --> CH3OOH + OQ 
      AI(342,I)= AR(74,I)/2.! H3CO + OQ --> H2CO + HQO 
      AI(343,I)= AR(85,I)   ! NO + HQO --> NO2 + QH 
      AI(344,I)= AR(91,I)   ! HQO + NO2 + M --> HQONO2 + M 
      AI(345,I)= AR(92,I)   ! HQONO2 + OH --> NO2 + H2O + OQ 
      AI(346,I)= AR(93,I)   ! HQONO2 + O --> NO2 + OH + O2  
      AI(347,I)= AR(94,I)   ! HQONO2 + M --> HQO + NO2 + M 
      AI(348,I)= AR(95,I)   ! HQONO2 + HV --> HQO + NO2 
      AI(349,I)= AR(103,I)  ! HQO + NO3 --> HNO3 + OQ 
      AI(350,I)= AR(120,I)/2. !HSO3 + OQ --> SO3 + HQO 
      AI(351,I)= AR(129,I)  ! HS + HQO --> H2S + OQ 
      AI(352,I)= AR(137,I)  ! S + HQO --> HS + OQ 
      AI(353,I)= AR(162,I)  ! SO + HQO --> HSO + OQ     

C-JL ADD FROM JAMES LYONS 2001 GRL
      AI(354,I) = 3.7E-11 
      AI(355,I) = 3.7E-11
      AI(356,I) = 2.3E-13*EXP(-2100./T(I))
      AI(357,I) = 2.3E-13*EXP(-2100./T(I))
      AI(358,I) = 1.8E-11
      AI(359,I) = 1.8E-11
      AI(360,I) = 1.0E-11
      AI(361,I) = 1.0E-11*0.5
      AI(362,I) = 1.7E-11*EXP(400./T(I))
      AI(363,I) = 1.7E-11*EXP(400./T(I))
      AI(364,I) = 3.6E-14
      AI(365,I) = 3.6E-14*0.5
C      AI(366,I) = 2.0E-22  
   4  CONTINUE
...
C MARCH 5, 2020 JL ADD TWO LONG SPECIES
        RAINGCI(LHQO,I) = RAINGC(LHO2,I)
        RAINGCI(LHQONO2,I) = RAINGC(LHO2NO2,I)
...
C JL ADD HQO HERE 
        ...
        DUI(LHQO,I) = DU(LHO2,I)
        DLI(LHQO,I) = DL(LHO2,I)
        DDI(LHQO,I) = DD(LHO2,I)
        DHUI(LHQO,I) = DHU(LHO2,I)
        DHLI(LHQO,I) = DHL(LHO2,I)
        HIZ(LHQO,I) = HI(LHO2,I)
        DKI(LHQO,I) = DK(LHO2,I)
C 6
...
C JL ADD HQONO2 HERE 
        DUI(LHQONO2,I) = DU(LHO2NO2,I)
        DLI(LHQONO2,I) = DL(LHO2NO2,I)
        DDI(LHQONO2,I) = DD(LHO2NO2,I)
        DHUI(LHQONO2,I) = DHU(LHO2NO2,I)
        DHLI(LHQONO2,I) = DHL(LHO2NO2,I)
        HIZ(LHQONO2,I) = HI(LHO2NO2,I)
        DKI(LHQONO2,I) = DK(LHO2NO2,I)
